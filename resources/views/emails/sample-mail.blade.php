                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;"
                                            src="{{ asset('assets/img/emails/Email-1_Intro.png') }}" width="190"
                                            border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <![endif]-->
                                                    ...
                                                    <a href="{{ config('pleb.mail.welcome_url') }}" target="_blank"
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <img style="display:block;width:100%;max-width:70px;border:0px;"
