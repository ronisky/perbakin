                                        ...
                                        <tr>
                                            <td align="left" valign="top" class="m_6406936670111343998main-content"
                                                ...
                                                <p
                                                    ...
                                                    Berdasarkan data yang kami terima mengenai pengajuan surat yang anda
                                                    lakukan <br>
                                                    Mohon maaf pengajuan surat Anda <b>Ditolak</b>.
                                                </p>
                                                <p
                                                    style="font-family:Helvetica,Arial,sans-serif;font-weight:normal;font-size:16px;line-height:1.6;margin:0 0 10px;padding:0">
                                                    Berikut data pengajuan Anda:
                                                </p>
                                                <div
                                                ...
                                                <p
                                                    style="font-family:Helvetica,Arial,sans-serif;font-weight:normal;font-size:16px;line-height:1.6;margin:0 0 10px;padding:0">
                                                    Berikut informasi yang kami sampaikan, Anda bisa masuk pada sistem
                                                    untuk melihat informasi lebih detail.<br>
                                                    <b>Untuk bisa mengajukan surat permohonan <br>
                                                        Silahkan melengkapi / memperbaiki kesalahan pengajuan Anda
                                                        sebelumnya, Atau Anda bisa mengajukan pengajuan surat baru</b>
                                                    <br> <br>
                                                </p>
                                                <p
                                                    style="font-family:Helvetica,Arial,sans-serif;font-weight:normal;font-size:16px;line-height:1.6;margin:0 0 10px;padding:0">
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" bgcolor="#008E89"
                                                                    ...
                                                                    <a href="{{ config('pleb.mail.success_letter_url') }}"
                                                                        target="_blank"
                                                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{ __('pleb.mail.action_button_letter') }}</span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- Login Button -->
