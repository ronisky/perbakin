	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							canvasPane 		: $('<div class="text-center"><canvas id="bcPaintCanvas" class="border border-dark rounded text-center"></canvas></div>'),
							bottom 			: $('<div class="col-sm-12 col-md-12 text-center mt-3" id="bcPaint-bottom"></div>'),
							buttonBatal 	: $('<button type="button" class="btn btn-danger btn-md mr-1" id="btnSignatureCancel">Batal</button>'),
							buttonReset 	: $('<button type="button" class="btn btn-warning btn-md mr-1" id="btnSignatureReset">Reset</button>'),
							buttonSave		: $('<button type="button" class="btn btn-success btn-md ml-1" id="btnSignatureSave">Simpan Tanda Tangan</button>')
						},
		paintCanvas,
		paintContext;
	...
	$.fn.bcPaint = function (options) {
		...
		return this.each(function () {
			var rootElement 	= $(this),
				...
				buttonBatal 	= templates.buttonBatal.clone(),
			...
			bcCanvas.attr('width', '300px');
			bcCanvas.attr('height', '150px');
