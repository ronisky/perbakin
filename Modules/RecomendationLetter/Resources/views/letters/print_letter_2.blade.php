...
{
    $this->Cell(10);
    $this->MultiCell(160,5,"     Dengan ini mengajukan ".ucwords($letter[0]->letter_category_name).".",0,'J',0);
...
function BodyDua($letter)
{
    ...
    $this->Cell(1, 5, ':', 0, 0, 'C');
    $this->Cell(120, 5, ucwords($letter[1]->nama_pemilik), 0, 0, 'L');
...
function BodyTiga()
{
    ...
    $this->Cell(15);
    $this->Cell(2, 5, 'a.', 0, 0, 'C');
    $this->Cell(32, 5, 'FC Surat Pernyataan Hibah Senpi', 0, 0, 'L');
    ...
    $this->Cell(15);
    $this->Cell(2, 5, 'c.', 0, 0, 'C');
    $this->Cell(32, 5, 'Foto Senjata', 0, 0, 'L');
...
$pdf = new PDF('P','mm','A4');
$pdf->AddPage();
$pdf->SetTitle(ucwords($letter[0]->letter_purpose_name));
$pdf->SetFont('Arial','',8);
