...
class UsersRepository extends QueryBuilderImplementation
{
    ...
    public $fillable = ['user_username', 'user_name', 'user_kta', 'user_email',  'user_phone', 'user_password', 'user_image', 'user_active_date', 'user_status', 'group_id', 'created_at', 'updated_at'];
