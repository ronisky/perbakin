...
<section id="articles" class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <h3 class="wow zoomIn" data-wow-delay=".2s">Artikel</h3>
                    ...
                    <a href="{{ url('details/'. Crypt::encrypt($article->article_id)) }}" target="_blank"
                        ...
                        <div class="cover-item" title="{{ $article->article_title }}">
                            <p class="text text-center mx-1 my-1">
                                @php
                                $title = substr($article->article_title, 0, 20);
                                @endphp
                                {{ $title }}
                            </p>
                            <img src="{{ url('storage/uploads/images/'. $article->image_thumbnail_path) }}"
                                class="d-block w-100" alt="{{$article->image_thumbnail_path }}">
                        </div>
                    </a>
                    <!-- END PANEL -->
                    @endforeach
